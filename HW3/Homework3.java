...
public class Homework3 {
  ...
  public static void smoosh(int[] ints) {
    ...
    // blank lines or lines already present in this file.)
	  ...
	  for(int currentIndex=0;currentIndex<length-1&&ints[currentIndex]!=-1;currentIndex++){
	  while(ints[currentIndex]==ints[currentIndex+1]){
		  for (int shuffled=currentIndex+1;shuffled<length-1;shuffled++){
			  ints[shuffled]=ints[shuffled+1];
		  }
		  ints[length-1]=-1;
	  }
	  }
