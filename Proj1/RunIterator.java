...
public class RunIterator implements Iterator {
  ...
  public boolean hasNext() {
    // Replace the following line with your solution.
	  if (currentRun.next!=null) return true;
	  else {
	  return false;}
  }
  ...
  public int[] next() {
    ...
    // Replace the following line with your solution.
	  ...
	  returnArray[0]=currentRun.node[3];
	  returnArray[1]=currentRun.node[0];
	  returnArray[2]=currentRun.node[1];
	  returnArray[3]=currentRun.node[2];
	  if(hasNext()) {currentRun=currentRun.next;}
	  return returnArray;
  }
